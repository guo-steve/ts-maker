...
const cmds = {
  ...
  install_eslint: 'npm install --save-dev eslint @typescript-eslint/parser @typescript-eslint/eslint-plugin eslint-plugin-import',
...
(async () => {
  ...
  if (answers.useHusky) {
    ...
    fs.copyFileSync(__dirname + 'files/.lintstagedrc.json', file, process.cwd() + '/.lintstagedrc.json')
